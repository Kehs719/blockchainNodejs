...
describe('Transaction', () => {
    ...
    describe('update()', () => {
        ...
        describe("and the amount is invalid", () => {
            it('throws an error', () => {
                expect(() => {
                    transaction.update({
                        senderWallet, recipient: 'foo-recipient', amount: 99999
                    });
        ...
        describe("and the amount is valid", () => {
            ...
            it("maintains a total amount that matches the input amount", () => {
    ...
    describe('rewardTransaction()', () => {
        ...
        it('creates a transaction wit the reward input', () => {
